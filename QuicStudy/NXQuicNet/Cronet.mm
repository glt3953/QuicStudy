...
#include "../chromium-net/components/cronet/ios/cronet_metrics.h"
#include "components/cronet/url_request_context_config.h"
#include "../chromium-net/ios/net/crn_http_protocol_handler.h"
#include "../chromium-net/ios/net/empty_nsurlcache.h"
...
//    gChromeNet.Get().reset(new cronet::CronetEnvironment(user_agent, gUserAgentPartial));

//  gChromeNet.Get()->set_accept_language(base::SysNSStringToUTF8(gAcceptLanguages ?: [self getAcceptLanguages]));
...
//  gChromeNet.Get()->set_experimental_options(base::SysNSStringToUTF8(gExperimentalOptions));
...
//  gChromeNet.Get()->set_enable_public_key_pinning_bypass_for_local_trust_anchors(gEnablePKPBypassForLocalTrustAnchors);
//  if (gNetworkThreadPriority != cronet::CronetEnvironment::kKeepDefaultThreadPriority) {
...
//  gHttpProtocolHandlerDelegate.Get().reset(new CronetHttpProtocolHandlerDelegate(gChromeNet.Get()->GetURLRequestContextGetter(), gRequestFilterBlock));
...
//  gNetworkThreadPriority = cronet::CronetEnvironment::kKeepDefaultThreadPriority;
